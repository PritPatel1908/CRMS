...
<html lang="en">
    ...
    <body>
        ...
        <!-- Datatable JS -->
        <script src="{{ asset('assets/plugins/datatables/js/jquery.dataTables.min.js') }}" type="3a1910e81f9f9b9575a9aaef-text/javascript">
        </script
        </script
        <script src="{{ asset('assets/plugins/datatables/js/dataTables.bootstrap5.min.js') }}"
            type="3a1910e81f9f9b9575a9aaef-text/javascript"></script>
        <!-- Daterangepicker JS -->
        <script src="{{ asset('assets/js/moment.min.js') }}" type="3a1910e81f9f9b9575a9aaef-text/javascript"></script>
        <script src="{{ asset('assets/plugins/daterangepicker/daterangepicker.js') }}" type="3a1910e81f9f9b9575a9aaef-text/javascript">
        </script>
        <!-- Apexchart JS -->
